...
dependencies {
    ...
    implementation(projects.editor.treeSitterNdk.javascript)
    implementation(projects.editor.treeSitterNdk.lua)
    implementation(projects.editor.treeSitterNdk.objectiveC)
    implementation(projects.editor.treeSitterNdk.objectiveCpp)
    implementation(projects.editor.treeSitterNdk.rust)
    implementation(projects.editor.treeSitterNdk.swift)
    implementation(projects.editor.treeSitterNdk.vue)
