 ...
 * @author Akash Yadav
 */
public final class TSLanguageLua {
   ...
   * name of this method is misleading, use {@link TSLanguageLua#getInstance()} instead.
   */
  @Deprecated
  ...
  /**
   * Get the instance of the Lua language.
   *
   * @return The instance of the Lua language.
   */
  public static TSLanguage getInstance() {
    var language = TSLanguageCache.get("lua");
    if (language != null) {
      return language;
    }

    language = TSLanguage.create("lua", Native.getInstance());
    TSLanguageCache.cache("lua", language);
    return language;
  }

  @GenerateNativeHeaders(fileName = "lua")
