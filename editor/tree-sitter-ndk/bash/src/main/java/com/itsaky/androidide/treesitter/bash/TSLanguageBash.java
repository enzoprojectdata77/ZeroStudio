...
public final class TSLanguageBash {
   ...
   * name of this method is misleading, use {@link TSLanguageBash#getInstance()} instead.
   */
  @Deprecated
  ...
  /**
   * Get the instance of the Bash language.
   *
   * @return The instance of the Bash language.
   */
  ...
  @GenerateNativeHeaders(fileName = "bash")
