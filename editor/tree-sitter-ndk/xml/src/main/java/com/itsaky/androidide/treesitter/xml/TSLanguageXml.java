...
public final class TSLanguageXml {
   ...
   * name of this method is misleading, use {@link TSLanguageXml#getInstance()} instead.
   */
  @Deprecated
  ...
  /**
   * Get the instance of the Xml language.
   *
   * @return The instance of the Xml language.
   */
  public static TSLanguage getInstance() {
    var language = TSLanguageCache.get("xml");
    if (language != null) {
      return language;
    }

    language = TSLanguage.create("xml", Native.getInstance());
    TSLanguageCache.cache("xml", language);
    return language;
  }

  @GenerateNativeHeaders(fileName = "xml")
