...
/**
 * Tree Sitter for Cmake.
 *
 * @author Akash Yadav / android_zero
 */
public final class TSLanguageCmake {

  static {
    System.loadLibrary("tree-sitter-cmake");
  }
   ...
   * name of this method is misleading, use {@link TSLanguageCmake#getInstance()} instead.
   */
  @Deprecated
  ...
  /**
   * Get the instance of the Cmake language.
   *
   * @return The instance of the Cmake language.
   */
  ...
  @GenerateNativeHeaders(fileName = "cmake")
