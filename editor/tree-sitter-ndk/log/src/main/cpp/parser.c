...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [aux_sym_begin_header_repeat1] = STATE(9),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [19] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_time, 7, .production_id = 4),
  [21] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_time, 7, .production_id = 4),
  ...
  [31] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_logs_repeat1, 2), SHIFT_REPEAT(9),
  [34] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_logs_repeat1, 2), SHIFT_REPEAT(31),
  [37] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_begin_header_repeat1, 2), SHIFT_REPEAT(8),
  [40] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_begin_header_repeat1, 2),
  [42] = {.entry = {.count = 1, .reusable = false}}, SHIFT(8),
  [44] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [46] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_begin_header, 2),
  [48] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_message, 1),
  [50] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ide_log_line, 6),
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_log_line, 7),
  ...
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pid, 1),
...
TS_PUBLIC const TSLanguage *tree_sitter_log() {
