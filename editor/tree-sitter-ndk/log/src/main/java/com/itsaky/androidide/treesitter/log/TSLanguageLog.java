...
public final class TSLanguageLog {
   ...
   * name of this method is misleading, use {@link TSLanguageLog#getInstance()} instead.
   */
  @Deprecated
  ...
  /**
   * Get the instance of the Log language.
   *
   * @return The instance of the Log language.
   */
  public static TSLanguage getInstance() {
    var language = TSLanguageCache.get("log");
    if (language != null) {
      return language;
    }

    language = TSLanguage.create("log", Native.getInstance());
    TSLanguageCache.cache("log", language);
    return language;
  }

  @GenerateNativeHeaders(fileName = "log")
