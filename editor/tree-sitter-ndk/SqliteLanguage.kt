...
import com.itsaky.androidide.treesitter.sqlite.TSLanguageSqlite
import io.github.rosemoe.sora.lang.Language.INTERRUPTION_LEVEL_SLIGHT
import io.github.rosemoe.sora.util.MyCharacter

/**
 * Tree Sitter language specification for .sqlite
 *
 * @author android_zero
 */
class SqliteLanguage(context: Context) :
    TreeSitterLanguage(context, TSLanguageSqlite.getInstance(), TS_TYPE) {

    companion object {

        const val TS_TYPE = "sqlite"
        
        @JvmField
        val FACTORY = Factory { SqliteLanguage(it) }
    }
