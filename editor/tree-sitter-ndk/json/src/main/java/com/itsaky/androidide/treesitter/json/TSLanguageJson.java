...
public final class TSLanguageJson {
   ...
   * name of this method is misleading, use {@link TSLanguageJson#getInstance()} instead.
   */
  @Deprecated
  ...
  /**
   * Get the instance of the Json language.
   *
   * @return The instance of the Json language.
   */
  ...
  @GenerateNativeHeaders(fileName = "json")
