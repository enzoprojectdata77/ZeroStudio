...
/**
 * @author android_zero
 * 定义了 Java 层 TSLanguageMarkdown.Native 类中 native 方法的元数据和注册逻辑。
 */
...
#ifndef _Included_com_itsaky_androidide_treesitter_markdown_TSLanguageMarkdown__Native_METHODS
#define _Included_com_itsaky_androidide_treesitter_markdown_TSLanguageMarkdown__Native_METHODS
...
#ifndef _Included_com_itsaky_androidide_treesitter_markdown_TSLanguageMarkdown__Native_METHOD_SIGNATURES
#define _Included_com_itsaky_androidide_treesitter_markdown_TSLanguageMarkdown__Native_METHOD_SIGNATURES
 ...
 * Signature: ()J
 */
static JNINativeMethod TSLanguageMarkdown_Native_getInstance= {
    .name = "getInstance",
    .signature = "()J",
    .fnPtr = nullptr
};
...
#define TSLanguageMarkdown_Native_AutoRegisterNatives(_env) \
    ...
    jclass _TSLanguageMarkdown_Native_class = _env->FindClass("com/itsaky/androidide/treesitter/markdown/TSLanguageMarkdown$Native"); \
    if (_TSLanguageMarkdown_Native_class == NULL) { \
