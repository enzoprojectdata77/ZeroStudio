 ...
 * @author Akash Yadav
 */
public final class TSLanguagePython {
   ...
   * name of this method is misleading, use {@link TSLanguagePython#getInstance()} instead.
   */
  @Deprecated
  ...
  /**
   * Get the instance of the Python language.
   *
   * @return The instance of the Python language.
   */
  public static TSLanguage getInstance() {
    var language = TSLanguageCache.get("python");
    if (language != null) {
      return language;
    }

    language = TSLanguage.create("python", Native.getInstance());
    TSLanguageCache.cache("python", language);
    return language;
  }

  @GenerateNativeHeaders(fileName = "python")
