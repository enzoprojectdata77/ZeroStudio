...
public final class TSLanguageYaml {
  ...
  static {
    System.loadLibrary("tree-sitter-yaml");
  }
   ...
   * name of this method is misleading, use {@link TSLanguageYaml#getInstance()} instead.
   */
  @Deprecated
  ...
  /**
   * Get the instance of the Yaml language.
   *
   * @return The instance of the Yaml language.
   */
  ...
  @GenerateNativeHeaders(fileName = "yaml")
