...
package com.itsaky.androidide.templates.impl.basicCpp
...
fun basicCppProject(): ProjectTemplate = baseProjectImpl {
  templateName = R.string.template_cpp
  thumb = R.drawable.cpp_configure
  defaultAppModule {
    recipe = createRecipe {
...
internal fun AndroidModuleTemplateBuilder.writeEmptyActivity(writer: SourceWriter) {
  writeMainActivity(writer, ::basicCppSrcKt, ::basicCppSrcJava)
}
