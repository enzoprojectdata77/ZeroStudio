 ...
 * It provides common functions to check for the terminal environment's readiness, locate executables,
 * and trigger installation scripts.
 *
 * @author android_zero
 */
object LspShellUtils {
    ...
    /**
     * Checks if the essential directories for the terminal environment (bin, lib) exist.
     * Most LSP servers depend on binaries located in these directories.
     *
     ...
     *
     * @return The absolute path to the Node.js executable if it exists, otherwise returns "node"
     *         as a fallback, assuming it's in the system's PATH.
     */
    ...
    /**
     * Executes a given installation script in a background thread using the `bash` shell.
     * This is a fire-and-forget operation designed for installing LSP server dependencies.
     *
