 ...
 * `didChangeConfiguration` notification to customize diagnostics, such as ignoring line-length warnings,
 * making it more suitable for mobile development.
 *
 * @author android_zero
 */
class PythonServer : BaseLspServer() {
     ...
     * This is a direct port of Xed-Editor's logic to improve the user experience by disabling
     * certain non-critical warnings.
     */
                ...
                "pylsp" to mapOf(
                    "plugins" to mapOf(
                        "pycodestyle" to mapOf(
                            "enabled" to true,
                            "ignore" to listOf("E501", "W291", "W293"), // Ignore long lines and trailing whitespace
