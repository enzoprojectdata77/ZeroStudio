 ...
 *
 * <p>
 * 负责分析项目的 <code>settings.gradle</code> 或 <code>settings.gradle.kts</code> 文件，
 * 提取其中配置的 Version Catalog (版本目录) 文件路径。
 * </p>
 *
 * <h3>主要功能:</h3>
 * <ul>
 *  <li><b>自动探测：</b> 总是优先检查 Gradle 默认约定的 <code>gradle/libs.versions.toml</code>。</li>
 *  <li><b>DSL 解析：</b> 解析 <code>dependencyResolutionManagement</code> 和 <code>versionCatalogs</code> 块，
 *      支持自定义 Catalog 别名和文件路径。</li>
 * </ul>
 */
