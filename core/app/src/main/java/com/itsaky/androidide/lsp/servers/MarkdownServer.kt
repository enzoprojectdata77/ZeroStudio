...
/**
 * An implementation of [BaseLspServer] for Markdown, utilizing the `vscode-markdown-language-server`.
 *
 * @author android_zero
 */
class MarkdownServer : BaseLspServer() {
    ...
    override val supportedExtensions: List<String> = listOf("md", "markdown", "mdown", "mkd", "mkdn", "mdoc", "mdtext", "mdtxt", "mdwn")
