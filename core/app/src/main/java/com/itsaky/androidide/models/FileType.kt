 ...
 * @property textmateScope The TextMate scope string used for syntax highlighting (e.g., "source.java").
...
enum class FileType(
    ...
    JAVASCRIPT(
        ...
        icon = R.drawable.ic_file_type_language_golang, // AndroidIDE currently uses this for JS in FileExtension
        title = "JavaScript",
    ...
    XML(
        extensions = listOf("xml", "xaml", "dtd", "plist", "ascx", "csproj", "wxi", "wxl", "wxs", "svg", "dae", "entitlements"),
