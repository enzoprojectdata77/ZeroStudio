...
data class SymbolInfo(
     ...
     */
    private fun getGeneralIcon(): Int = when (type) {
     ...
     * JSON 专用图标
     */
    private fun getJsonIcon(): Int = when (type) {
        ...
        SymbolType.FIELD, SymbolType.VARIABLE -> R.drawable.ic_symbol_ksymbol
    ...
    val typeLetter: String
        get() = when (type) {
            ...
            SymbolType.METHOD, SymbolType.FUNCTION -> "M"
            SymbolType.FIELD -> "F"
